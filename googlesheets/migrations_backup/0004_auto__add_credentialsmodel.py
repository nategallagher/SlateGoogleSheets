...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('googlesheets_credentialsmodel', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], primary_key=True)),
            ('credential', self.gf('oauth2client.contrib.django_orm.CredentialsField')(null=True)),
        ))
        db.send_create_signal('googlesheets', ['CredentialsModel'])


    def backwards(self, orm):
        # Deleting model 'CredentialsModel'
        db.delete_table('googlesheets_credentialsmodel')
