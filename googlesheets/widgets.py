...
from django.forms.widgets import Widget, Select, MultiWidget, DateInput, TextInput
...
class DateInputWithDatepicker(forms.DateInput):
    ...
    def render(self, name, value, attrs=None):
        ...
        return super(DateInputWithDatepicker, self).render(name, \
                                                             value, attrs)
...
class SelectTimeWidget(Widget):
    """
    found at https://djangosnippets.org/snippets/1202/
    ...
    def __init__(self, attrs=None, hour_step=None, minute_step=None, second_step=None, twelve_hr=False):
        ...
        if twelve_hr:
            ...
            self.meridiem_val = 'PM' # Default to Evening PM
    ...
    def render(self, name, value, attrs=None):
        ...
        if self.twelve_hr:
            ...
            if self.meridiem_val is not None and  self.meridiem_val.startswith('p'):
                    meridiem_choices = [('PM.','PM'), ('AM','AM')]
            else:
                meridiem_choices = [('AM','AM'), ('PM','PM')]
...
class SplitTimeWidget(MultiWidget):
    ...
    def __init__(self, attrs=None, time_format=None):
        ...
        widgets = (TextInput(attrs=time_attrs), TextInput(attrs=time_attrs), 
    ...
    def format_output(self, rendered_widgets):
        """ Given a list of rendered widgets (as strings), it inserts 
        an HTML linebreak between them.
